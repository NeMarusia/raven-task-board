...
Windows/macOS-сборки собираются через GitHub Actions workflow **Build RTB Desktop**. Подробная инструкция по установке, обновлению и релизам: [INSTALL.md](INSTALL.md).
